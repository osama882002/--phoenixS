...
@section('content')
    <div
        class="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-100 dark:from-gray-800 to-white dark:to-gray-900 py-12">
        <div class="max-w-md w-full bg-white dark:bg-gray-800 shadow-lg rounded-2xl p-8 text-right">
            ...
            <div class="mt-4">
                <a href="{{ url('/auth/google') }}"
                    class="w-full flex justify-center items-center gap-2 bg-white border border-gray-300 text-gray-800 font-semibold py-2 rounded-lg shadow-sm hover:bg-gray-100 transition">
